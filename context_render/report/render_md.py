"""markdown renderer (A4.4): full report to file + stdout; charts and timeline locked to monospace via code block.
...
from .render_term import analyze_lines, session_lines, window_lines
