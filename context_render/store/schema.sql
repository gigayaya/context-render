-- context-render DDL (v4: stale_windows)
...
CREATE TABLE IF NOT EXISTS facts (
  session_id    TEXT NOT NULL REFERENCES sessions(id) ON DELETE CASCADE,
  idx           INTEGER NOT NULL,   -- merged-stream event number (evidence ref)
...
-- the `component` view that wrote edit-epoch rows here was removed before v0.2.0 shipped.
